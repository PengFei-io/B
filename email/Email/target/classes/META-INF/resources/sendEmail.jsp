...
<body>
<div class="content">
    <h4 class="email-title"><span>局长信箱</span></h4>
    <form class="sub-form" action="${pageContext.servletContext.contextPath}/email/send" method="post"
          enctype="multipart/form-data">
        <div class="item"> 标题： <input type="text" name="title"><span class="mustbe">*（必填）${message}</span></div>

        <div class="item"> 内容： <textarea name="content"></textarea></div>
        <div class="item pr"> 附件： <input class="upinput" type="text"/><span class="upbtn">点击上传</span><input
                class="upfile" type="file" name="doc"><span class="mustbe">大小不超过10M，支持常见文件格式</span></div>

        <div class="item">
            <div class="row-ul clearfix">
                <div>发件人: <input type="text" name="sender"></div>
                <div>单位: <input type="text" name="company"></div>
                <div>联系方式: <input type="text" name="phoneNum"></div>
            </div>
        </div>
        <div class="item tr"><input type="submit" value="发送"></div>
    </form>
</div>
</body>
</html>
